/**
 * The notification logic — imported by the Worker entry point (../cron.js) and
 * by the tests. Kept out of cron.js on purpose: see the note there.
 *
...
import { readServiceAccount, getAccessToken, sendToDevice } from './fcm.js';
