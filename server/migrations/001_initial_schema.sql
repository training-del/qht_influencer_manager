-- Baseline schema.
--
-- Everything the app started life with. A database that already existed before
-- migrations were introduced is marked as having run this without replaying it,
-- so this file must keep describing that same starting point — never edit it.
